...
const router = express.Router() // aqui estou configurando a primeira porta
const { v4: uuidv4 } = require('uuid')

const app = express() // aqui estou criando o app
app.use(express.json())
const porta = 3333 // aqui estou criando a pota
...
app.use(router.delete('/mulheres/:id', deletaMulher)); // Configure DELETE /mulheres/:id route
